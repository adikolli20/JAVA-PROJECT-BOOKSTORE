...
public class BookView extends View{
    ...
    private final TableColumn<Book, String> publisherCol = new TableColumn<>("Publisher");
    ...
    private void setForm() {
        ...
        formPane.getChildren().addAll(isbnLabel, titleLabel, purchasedPriceLabel, sellingPriceLabel,
                authorLabel, dateLabel,categoryFieldLabel,stockLabel,quantityLabel,saveBtn,DeleteBtn);
    }
    ...
    private void setTableView() {
        ...
        tableView.getColumns().addAll(isbnCol, titleCol, purchasedPriceCol, sellingPriceCol, authorCol,publisherCol,dateCol,quantityCol);
    }
